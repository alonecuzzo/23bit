...
category:a.category,ctype:a.ctype,custom_link:a.custom_link,li_margin:a.li_margin,short_link:a.short_link,shortener:a.shortener,shortener_key:encodeURIComponent(a.shortener_key),shrlink:a.shrlink,expand:a.expand,dontShowShareCount:a.dontShowShareCount,fbLikeButton:a.fbLikeButton,fbButtonPos:a.fbButtonPos,twitter_overlay:a.twitter_overlay};a.center&&b(this).css({"margin-left":j(b(this).width())});a.mode=="inject"?b(this).shareaholic(c):b(this).append(b('<iframe frameborder="0"/>').attr({src:[a.src+
a.iframe_src,b.param(c)].join("?"),height:e(b(this).width()),width:b(this).width(),scrolling:"no","class":"share-iframe"}).css({height:h(b(this).width())}));if(a.expand){b(this).css({overflow:"hidden",height:e(b(this).width())});b(this).hover(function(){b(this).animate({height:h(b(this).width())},{duration:a.duration,queue:false})},function(){b(this).animate({height:e(b(this).width())},{duration:a.duration,queue:false})})}});return this};SHR4P.debug("initializing shareaholic plugin");b.fn.shareaholic=
function(c){var a=b.extend({service:"",rel:"nofollow",target:"_blank",poller_timeout:200,link:"",title:"",notes:"",bgimg:"",bgimg_padding:"",twitter_template:"${title} - ${short_link}",tags:"",category:"",ctype:"",localize:false,custom_link:{},li_margin:0,share_src:SHR4P.base_url,src:SHR4P.base_url,api:{share:{v:"1",url:"/api/share/",apitype:"1",source:"Shareaholic-Publishers"},sprite:{v:"2",url:"/api/sprite/"}},short_link:"",shortener:"google",shortener_key:"",shortener_services:{"bit.ly":function(a,
b){var e=function(){SHR4P.debug("bitly javascript loaded");var e=a.link;BitlyCB.mycallback=function(a){SHR4P.debug("bit.ly calls back with");SHR4P.debug(a);if(a.errorCode==0){SHR4P.debug("successfully shortened, calling callback with: ");a=a.results[e].shortUrl;SHR4P.debug("short_link: "+a);SHR4P.debug("type: "+typeof a);b(a)}};BitlyClient.call("shorten",{longUrl:e},"BitlyCB.mycallback")};if(typeof BitlyClient=="undefined"){SHR4P.debug("loading bit.ly");var c=document.getElementsByTagName("head")[0];
if(typeof c!="undefined"){var h=a.shortener_key.split("|"),d=document.createElement("script");d.src="http://bit.ly/javascript-api.js?version=latest&login="+h[0]+"&apiKey="+h[1];d.type="text/javascript";d.charset="utf-8";c.appendChild(d);d.onreadystatechange=function(){if(this.readyState=="complete"||this.readyState=="loaded"){SHR4P.debug("bit.ly loaded with onreadystatechange, init'ing");e()}};d.onload=e}}else{SHR4P.debug("bit.ly already loaded.  init'ing");e()}}}},c);SHR4P.debug("$.fn.shareaholic called");
SHR4P.debug(a);b(this).addClass("shareaholic-show-on-load");if(a.localize==true||a.localize=="true")a.localize=true;if(!a.link||a.link&&a.link==="")a.link=b(this).attr("data-shr_href")||document.location.href;if(!a.title||a.title&&a.title==="")a.title=b(this).attr("data-shr_title")||document.title;var f=function(a,e){return[a,b.param(e)].join("?")},c=function(a){for(var b=[],e=a.length,c=0;c<e;c++){for(var d=c+1;d<e;d++)a[c]===a[d]&&(d=++c);b.push(a[c])}return b},d=function(a,e,c){var d=c.designer_toolTips?
"orig_title":"title",h=c.custom_link[a+"_"+e];SHR4P.debug("adding link "+a+" "+e);return b("<li/>").addClass(h.li_class).append(b("<a/>").attr({href:h.link,rel:c.rel,target:c.target,"class":"external"}).attr(d,h.tooltip).text(h.tooltip)).attr("style",h.style+";margin-left:"+c.li_margin+"px !important;")},g=a.localize?a.src+"/sprite.css":f(a.src+a.api.sprite.url,{v:a.api.sprite.v,apikey:a.apikey,service:c(a.service.split(",")).sort().join(",")});b("#shareaholic-publisher-css").length==0&&b("head").append(b('<link rel="stylesheet" media="screen" id="shareaholic-publisher-css" href="'+
